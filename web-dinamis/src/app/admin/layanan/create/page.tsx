...
const ICONS = ["flower", "box", "heart", "car", "book", "home", "shield", "globe", "star", "map-pin", "moon", "sun"];
        ...
        <form action={createLayanan}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
            <div className="admin-form-group" style={{ gridColumn: "1 / -1" }}>
              ...
              <input name="nama" required type="text" className="admin-form-input" placeholder="Contoh: Pemakaman VIP" />
            </div>
