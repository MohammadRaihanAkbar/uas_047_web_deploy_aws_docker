    ...
    <section>
      <div style={{ paddingBottom: "2rem", textAlign: "center" }}>
        ...
        <p className="section-subtitle">
          Informasi, pembaruan, dan wawasan terkini dari Taman Abadi Memorial Park
        </p>
      </div>
