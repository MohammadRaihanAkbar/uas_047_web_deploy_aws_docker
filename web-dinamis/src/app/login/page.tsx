        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <h1 style={{
              ...
              Taman<span style={{ WebkitTextFillColor: "#34d399", backgroundImage: "none" }}>Abadi</span>
            </h1>
            <p style={{ color: "#64748b", fontSize: "14px", margin: 0, letterSpacing: "0.3px" }}>
              Panel Admin Memorial Park
            </p>
          </div>
          ...
          <p style={{ textAlign: "center", marginTop: "24px", color: "#334155", fontSize: "12px" }}>
            © 2026 Taman Abadi Memorial Park • Secure Control Panel
          </p>
        </div>
      </div>
    </div>
